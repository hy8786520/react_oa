...
let reportStatus = {};
if (!global.reportStatus) {
  const data = {
    stat: 'close',
    report_start_date: '2017-02-15',
    report_end_date: '2017-02-18',
    review_start_date: '2017-02-15',
    review_end_date: '2017-02-21',
    work_start_date: '2017-01-15',
    work_end_date: '2017-02-15'
  };
  global.reportStatus = data;
} else {
  reportStatus = global.reportStatus;
}
...
module.exports = {
  ...
  'POST /api/report/status' (req, res) {
    const params = qs.parse(req.body);
    global.reportStatus = params;
    res.json({
      success: 'true'
    });
  },
